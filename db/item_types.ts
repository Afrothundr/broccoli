...
export const ITEM_TYPES: Record<
  string,
  { name: string; storage_advice: string; suggested_life_span_seconds: number; category: string }
> = {
  Apples: {
    name: "Apples",
  ...
  Citrus: {
    name: "Citrus",
    storage_advice: "Refrigerate loose in your low-humidity crisper drawer at 41°F to 42°F",
  ...
  "Whole Melons": {
    name: "Whole Melons",
    storage_advice: "Refrigerate after ripe, keep out of direct sunlight when ripening",
  ...
  Pineapples: {
    name: "Pineapples",
    storage_advice: "Refrigerate in a low humidity drawer, if cut store in an airtight container.",
    suggested_life_span_seconds: dayjs.duration({ days: 5 }).asSeconds(),
    category: "Fruit",
  },
  Papayas: {
  ...
  Artichokes: {
    name: "Artichokes",
    storage_advice: "Refrigerate in a high humidity drawer in airtight container.",
    suggested_life_span_seconds: dayjs.duration({ weeks: 1 }).asSeconds(),
    category: "Vegetables",
  },
  Asparagus: {
    name: "Asparagus",
    storage_advice: "Refrigerate upright in a bowl or dish with 1 inch of water",
    suggested_life_span_seconds: dayjs.duration({ days: 3 }).asSeconds(),
    category: "Vegetables",
  },
  Beets: {
    name: "Beets",
    storage_advice: "Refrigerate in a high humidity drawer in breathable container.",
    suggested_life_span_seconds: dayjs.duration({ weeks: 1 }).asSeconds(),
    category: "Vegetables",
  },
  Broccoli: {
  ...
  Cauliflower: {
    name: "Cauliflower",
    storage_advice: "Store in the refrigerator in high-humidity drawer with a breathable bag.",
  ...
  Kale: {
    name: "Kale",
    storage_advice: "Store in high-humidity drawer, do not wash until ready to use.",
    suggested_life_span_seconds: dayjs.duration({ days: 3 }).asSeconds(),
    category: "Vegetables",
  },
  Chard: {
  ...
  Mushrooms: {
    name: "Mushrooms",
    storage_advice: "Use ASAP. Store in lower shelf of refrigerator in original packaging.",
    suggested_life_span_seconds: dayjs.duration({ weeks: 1 }).asSeconds(),
    category: "Mushrooms",
  },
  Onions: {
  ...
  Parsnips: {
    name: "Parsnips",
    storage_advice: "Store in breathable bag in high-humidity drawer of refrigerator",
    suggested_life_span_seconds: dayjs.duration({ weeks: 3 }).asSeconds(),
    category: "Vegetables",
  },
  Peppers: {
    name: "Peppers",
    storage_advice: "Store in breathable bag in low-humidity drawer of refrigerator",
    suggested_life_span_seconds: dayjs.duration({ days: 5 }).asSeconds(),
    category: "Vegetables",
  },
  Potatoes: {
  ...
  Radishes: {
    ...
    suggested_life_span_seconds: dayjs.duration({ weeks: 1, days: 3 }).asSeconds(),
    category: "Vegetables",
  },
  Squash: {
    name: "Squash",
  ...
  "Deli meat": {
    name: "Deli meat",
    storage_advice: "Store on bottom shelf of refrigerator in original packaging.",
    suggested_life_span_seconds: dayjs.duration({ days: 5 }).asSeconds(),
    category: "Meat",
  },
  "Fresh meat": {
    name: "Fresh meat",
    storage_advice: "Store on bottom shelf of refrigerator in airtight packaging.",
  ...
  "Hard Cheese": {
    name: "Hard Cheese",
    storage_advice: "Store in refrigerator drawer wrapped loosely in paper or wax",
    suggested_life_span_seconds: dayjs.duration({ months: 1 }).asSeconds(),
    category: "Dairy",
  },
  "Soft Cheese": {
  ...
  Milk: {
    name: "Milk",
    storage_advice: "Keep in cold part of the refrigerator",
    suggested_life_span_seconds: dayjs.duration({ weeks: 1, days: 2 }).asSeconds(),
    category: "Dairy",
  },
  Yogurt: {
    name: "Yogurt",
